...
data class Specie(
    ...
    @ColumnInfo(name = "skin_colors") val averageHeight: String,
    @ColumnInfo(name = "skin_colors") val averageLifespan: String,
    @ColumnInfo(name = "hair_colors") val hairCcolors: String,
    @ColumnInfo(name = "skin_colors") val skincolors: String,
    @ColumnInfo(name = "skin_colors") val eyeColors: String,
    val language: String,
    val url: String,
